    ...
    <div className="w-full h-auto">
      {showClassification ? (
        ...
        <form
          ...
          className="relative py-5 px-10 flex flex-col items-center justify-center w-full"
        >
          {loading && (
            <img
          ...
          <div className="mb-5 flex flex-col items-center justify-center ">
            <select
              className="w-[160px] h-8 outline-none"
              defaultValue="Number of Baskets"
              onChange={handleTotalBaskets}
            >
              <option className="text-center" disabled hidden>
                Number of Baskets
              </option>
          ...
          {totalBaskets === "1" ? (
            <div className="relative bg-[#cd97ff] rounded w-[90%] h-fit flex flex-col items-center  py-5 space-y-2 ">
              <span className="absolute bg-slate-500 text-[12px] text-white px-[5px] border  left-0 top-0 font-semibold">
                Basket #1
              </span>
              <div className="relative flex items-center justify-center  space-x-2">
                <h4 className="">Number of Items: </h4>
                <input
                  onChange={handleItemsBasket1}
                  value={itemsBasket1}
                  required
                  className="w-10 text-center outline-none appearance-none"
                  type="number"
                />

                {itemsError1 && (
                  <span className="absolute text-[red] right-[-150px] animate-pulse">
                    Error [1 - 1000 Max]
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center justify-center  space-x-2">
                ...
                <input
                  required
                  value={basketName1}
                  onChange={(e) => setBasketName1(e.target.value)}
              ...
              {divTags1.map((e, i) => {
                return (
                  <div
                    key={i}
                    className="relative flex items-center justify-center w-full border-[1px] border-slate-500  space-x-2 py-5 bg-[#cd97ff] hover:bg-[#cd84ff] cursor-pointer "
                  >
                    <div className="flex items-center justify-center space-x-2 flex-wrap ">
                      <span className="absolute bg-slate-500 text-[12px] text-white px-[5px] border font-semibold left-0 top-0">
                        {i + 1}
                      </span>
              ...
              <div className="relative bg-[#cd97ff] rounded w-[90%] h-fit flex flex-col items-center  py-5 space-y-2">
                ...
                <div className="flex items-center justify-center  space-x-2">
                  ...
                  <input
                    required
                    value={basketName2}
                    onChange={(e) => setBasketName2(e.target.value)}
                    className="outline-none"
                    type="text"
                  />
                </div>
              ...
              <div className="relative bg-[#cd97ff] rounded w-[90%] h-fit flex flex-col items-center  py-5 space-y-2">
                ...
                <div className="flex items-center justify-center  space-x-2">
                  ...
                  <input
                    required
                    value={basketName3}
                    onChange={(e) => setBasketName3(e.target.value)}
                    className="outline-none"
                    type="text"
                  />
                </div>
              ...
              <div className="relative bg-[#cd97ff] rounded w-[90%] h-fit flex flex-col items-center  py-5 space-y-2">
                ...
                <div className="flex items-center justify-center  space-x-2">
                  ...
                  <input
                    required
                    value={basketName4}
                    onChange={(e) => setBasketName4(e.target.value)}
                    className="outline-none"
                    type="text"
                  />
                </div>
              ...
              <div className="relative bg-[#cd97ff] rounded w-[90%] h-fit flex flex-col items-center  py-5 space-y-2">
                ...
                <div className="flex items-center justify-center  space-x-2">
                  ...
                  <input
                    required
                    value={basketName5}
                    onChange={(e) => setBasketName5(e.target.value)}
                    className="outline-none"
                    type="text"
                  />
                </div>
