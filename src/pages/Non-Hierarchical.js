          ...
          {myBasket1 !== "" ? (
            <div className="flex flex-col items-center justify-center">
              <div className="flex flex-col relative items-center justify-center border border-black w-24 h-11 cursor-pointer bg-white/80 hover:bg-white">
                <div className="w-full h-full text-center mt-4 font-semibold ">
                  {myBasket1}
                </div>
                <div className="bg-slate-600 absolute top-0 text-[10px] h-4 w-full text-center font-semibold text-white">
                  Basket #1
                </div>
              </div>
              {myBasket1Items.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col relative items-center justify-center border border-black w-24 h-9 cursor-pointer bg-white/80 border-t-0 hover:bg-white"
                >
                  <div className="w-full h-full text-center mt-4 text-[12px] font-medium">
                    {item}
                  </div>
                  <div className="bg-slate-500 absolute top-0 text-[10px] h-4 w-full text-center font-semibold text-white">
                    item #{index + 1}
                  </div>
                </div>
              ))}
              ...
              <table className="table-auto border-2 border-separate border-black text-center bg-white/60">
                ...
                <tbody>
                  ...
                  <tr className="hover:bg-white/90 cursor-pointer">
                    ...
                    <td className="border-2  border-black">
                      {JSON.stringify(cfState.basketOrder)}
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-white/90 cursor-pointer">
                    ...
                    <td className="border-2  border-black">
                      {JSON.stringify(cfState.finalOutput)}
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                {showItemsPermutation ? (
                  <form className="relative py-5 px-10 flex flex-col items-center justify-center  w-full">
                    ...
                    <h1 className="text-[24px] font-semibold mb-5">
                      Select the Permutation of Items Order
                    </h1>
                  ...
                  <form className="relative py-5 px-10 flex flex-col items-center justify-center  w-full">
                    ...
                    <h1 className="text-[24px] font-semibold mb-5">
                      Select items from 3rd Basket: {myBasket3}
                    </h1>

                    <div className="flex items-center justify-center gap-5 flex-wrap">
                      {currentBasketItems.map((item, index) => (
                        <button
                          onMouseUp={handleitems2}
                          onClick={submit5thItem}
                          className={
                            parseInt(isItemSelected) === index
                              ? "bg-purple-700 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-500"
                              : "bg-purple-500 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-700"
                      ...
                      <>
                        {showItemsPermutation ? (
                          ...
                          <form className="relative py-5 px-10 flex flex-col items-center justify-center  w-full">
                            ...
                            <h1 className="text-[24px] font-semibold mb-5">
                              Select items from 2nd Basket: {myBasket2}
                            </h1>

                            <div className="flex items-center justify-center gap-5 flex-wrap">
                              {currentBasketItems.map((item, index) => (
                                <button
                                  onMouseUp={handleitems1}
                                  onClick={submit3rdItem}
                                  className={
                                    parseInt(isItemSelected) === index
                                      ? "bg-purple-700 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-500"
                                      : "bg-purple-500 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-700"
                                ...
                                {showItemsPermutation ? (
                                  ...
                                  <form className="relative py-5 px-10 flex flex-col items-center justify-center  w-full">
                                    ...
                                    <div className="flex items-center justify-center gap-5 flex-wrap">
                                      {currentBasketItems.map((item, index) => (
                                        <button
                                          onMouseUp={handleitems}
                                          onClick={submit1stItem}
                                          className={
                                            parseInt(isItemSelected) === index
                                              ? "bg-purple-700 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-500"
                                              : "bg-purple-500 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-700"
                                        ...
                                        {basketScreen3B ? (
                                          <>
                                            <form className="relative py-5 px-10 flex flex-col items-center justify-center ">
                                              ...
                                              <h1 className="text-[24px] font-semibold mb-5">
                                                Select the 3rd Basket
                                              </h1>

                                              <div className="flex items-center justify-center gap-5 flex-wrap">
                                                {baskets.map((item, index) => (
                                                  <button
                                                    onMouseUp={handleBasket3}
                                                    onClick={submitBasket3}
                                                    className={
                                                      parseInt(isSelected) ===
                                                      index
                                                        ? "bg-purple-700 cursor-pointer text-white font-semibold py-2 px-5 rounded hover:bg-purple-500"
